...
class MvcNamespaceUtils(mock.MagicMock):
    ...
    BEAN_NAME_URL_HANDLER_MAPPING_BEAN_NAME = "BeanNameUrlHandlerMapping.class.getName()"
    SIMPLE_CONTROLLER_HANDLER_ADAPTER_BEAN_NAME = "SimpleControllerHandlerAdapter.class.getName()"
    HTTP_REQUEST_HANDLER_ADAPTER_BEAN_NAME = "HttpRequestHandlerAdapter.class.getName()"
    ...
    def registerDefaultComponents(self, parserContext: ParserContext, source=None):
        # TODO
